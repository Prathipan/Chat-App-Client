...
import { api } from "../../api";
import { getFullSender, getSender } from "../../codeLogics/ChatLogic";
...
const SingleChat = ({ fetchCall, setFetchCall }) => {
  ...
  const fetchMessages = async () => {
    ...
    try {
      ...
      const { data } = await axios.get(
        `${api}/api/message/all-messages/${selectedChat._id}`,
        config
      );
